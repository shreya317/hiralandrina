    ...
    <div className='Events'>
        ...
        <div className='Events-sangeet'>
            <div className='Events-desc'>
                <div className='Event-title'><h2>Sangeet</h2></div>
        ...
        <div className='Events-wedding'>
            <div className='Events-desc'>
                <div className='Event-title'><h2>Wedding</h2></div>
                <div className='Event-text'>
                <p>Saturday, July 6, 2019</p>
                <p>10:00 AM Baraat</p>
                <p>10:30 AM Wedding Ceremony</p>
        ...
        <div className='Events-reception'>
            <div className='Events-desc'>
                <div className='Event-title'><h2>Reception</h2></div>
                <div className='Event-text'>
                <p>Saturday, July 6, 2019</p>
